...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-background text-foreground overflow-hidden px-4 sm:px-6">
      {/* Enhanced Background Textures - Matching About component */}
      ...
      {/* Background Glow - Updated to use primary color */}
      <motion.div
      ...
      >
        <div className="absolute w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] lg:w-[600px] lg:h-[600px] bg-primary/20 blur-[120px] sm:blur-[180px] rounded-full" />
      </motion.div>
      ...
      >
        ...
        <div className="text-center sm:text-left relative z-20 mb-8 sm:mb-0">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/60 backdrop-blur-sm border border-border mb-4"
          >
          ...
          <h1 className="font-grotesk font-extrabold leading-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl tracking-tight bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            BRUNO SIMON
          </h1>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 lg:gap-8 relative z-20">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-4 sm:gap-6 lg:gap-2">
            <motion.a
              ...
              className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors group font-satoshi"
              whileHover={{ x: 5 }}
            >
              <Mail className="w-4 h-4 text-primary" />
              <span>Thiyo80203@gmail.com</span>
            </motion.a>
            <motion.a
          ...
          <div className="flex-1 max-w-2xl">
            <motion.p
              className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-6 text-center lg:text-right font-grotesk"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <Button
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 rounded-full font-satoshi font-semibold group"
                size="lg"
              >
                View My Work
            ...
            >
              {[
                ...
                <motion.a
                  key={platform}
                  href={href}
                  className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-sm font-satoshi font-medium py-2"
                  whileHover={{ y: -2 }}
                >
