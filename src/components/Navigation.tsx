              ...
              {navLinks.map((link) => (
                ...
                >
                  <button
                    ...
                    className={`font-grotesk text-sm lg:text-base transition-colors duration-200 px-3 py-2 relative whitespace-nowrap ${isActiveLink(link.path)
            ...
            <div className="hidden md:flex items-center flex-shrink-0 ml-2">
              ...
              >
                <Button
                  ...
                  className={`font-grotesk transition-all duration-200 whitespace-nowrap ${isActiveLink("/contact-Page")
                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      ...
                      >
                        <button
                          onClick={() => handleNavClick(link.path)}
                          className={`flex items-center w-full px-4 py-3 rounded-xl transition-all duration-200 group ${isActiveLink(link.path)
                ...
                >
                  ...
                  >
                    <Button
                      size="lg"
                      onClick={() => handleNavClick("/contact-Page")}
                      className={`w-full font-grotesk text-base transition-all duration-200 ${isActiveLink("/contact-Page")
